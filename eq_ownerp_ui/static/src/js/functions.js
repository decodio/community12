...
odoo.define('eq_ownerp_ui', function (require) {
    'use strict';
    ...
    AppsMenu.include({
        events: _.extend({
            ...
            "click .dropdown-menu": "_dontHide",
            "click #eq_close_menu": "_closeMenu"
        ...
        _searchMenus: function () {
            ...
            this.$search_results.html(
                core.qweb.render(
                    "eq_ownerp_ui.MenuSearchResults",
                    {
                        results: results,
                        widget: this,
                    }
    ...
    FormRenderer.include({
        ...
        _renderHeaderButtons: function () {
            ...
            var $dropdown = $(core.qweb.render(
                'eq_ownerp_ui.MenuStatusbarButtons'
            ));
    ...
    ActionManager.include({
        ...
        */
        _hideMenusByAction: function (action) {
            $(".dropdown-menu").removeClass('show');
            $("#eq_close_menu").css("display", "block");
        },
